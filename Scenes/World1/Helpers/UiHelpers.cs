...
namespace LastLaugh.Scenes.World1.Helpers
{
    internal class UiHelpers
    {
        ...
        internal static void DrawTextWithBackground(TextureKey textureKey, string text, Vector2 position, bool centered = false)
        {
            ...
            var size = Raylib.MeasureTextEx(LastLaughEngine.Instance.Font, text, 24, 0);
            ...
            Raylib.DrawTextEx(LastLaughEngine.Instance.Font, text, position, 24, 0f, Color.Black);
        }
        ...
        internal static void DrawToolTipOnMouse()
        {
            ...
            var size = Raylib.MeasureTextEx(LastLaughEngine.Instance.Font, text, textSize, 0);
            var rect = new Rectangle((int)position.X, (int)position.Y, SideBarInnerWidth, size.Y);
            ...
            //Raylib.DrawTextureNPatch(texture, patch, rect, Vector2.Zero, 0f, Color.White);
            Raylib.DrawTextEx(LastLaughEngine.Instance.Font, text, position, textSize, 0f, Color.Black);
        }
    }
}
