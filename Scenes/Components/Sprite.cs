...
namespace LastLaugh.Scenes.Components
{
    internal class Sprite : Render
    {
        ...
        internal BodyTypes BodyType = BodyTypes.Static;

        public Sprite(TextureKey key, float scale = 1, bool isCentered = true) : base(key, scale, isCentered)
        {
            var animationDataPath = TextureManager.Instance.FilePathMapping[key];
        ...
        public override Rectangle CollisionDestination
        {
            get =>
