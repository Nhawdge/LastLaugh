...
namespace LastLaugh.Scenes.MainMenu.Systems
{
    internal class MenuSystem : GameSystem
    {
        ...
        {
            if (LastLaughEngine.Instance.ActiveScene is MainMenuScene parent)
            {
                ...
                if (parent.LoadingTime > 10)
                {
                    ...
                    if (LastLaughEngine.Instance.ActiveScene is MainMenuScene mainMenu)
                    {
                        mainMenu.Logo.Draw();
                    }
